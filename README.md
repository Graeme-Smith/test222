...
- 🎯 Entry points to execute your program using `python -m <test222>` or `$ test222` with basic CLI argument parsing.
...
---
# test222 Flask Application

Awesome test222 created by Graeme-Smith
...
```bash
git clone https://github.com/Graeme-Smith/test222 test222
cd test222
make install
```
...
```bash
test222 create-db   # run once
test222 populate-db  # run once (optional)
test222 add-user -u admin -p 1234  # ads a user
test222 run
```
